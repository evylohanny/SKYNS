    ...
    const fetchAllProductPhotos = async (productsList) => {
      ...
      for (const product of productsList) {
        try {
          ...
          console.log(
            `Erro ao buscar foto do produto ${product.id_produto}:`,
            error
          );
  ...
  const comments = [
    {
      ...
      description:
        "Acordo com a pele super macia e renovada! Esse creme noturno é maravilhoso, tem uma textura leve e um cheirinho calmante. Parece que minha pele descansa junto comigo.",
      stars: 5,
    },
    {
      product_title: "Creme Noturno Regenerador",
...
const valor_produto = async (item) => {
  ...
  return mostrarLogo && logoAnimation ? (
    ...
    <div
      className={clsx(
        "flex flex-col w-full h-[1050vh] mt-[-0.9%] items-center gap-10",
        logoAnimation && "animate-fadeInUp"
      )}
    >
      <NavBar />
              ...
              <SwiperSlide key={index} className="relative h-full w-full">
                ...
                {(index === 0 || index === 2) && (
                  <div
                    className={
                      index === 0
                        ? "absolute z-100 left-[8%] top-[70%] flex flex-col gap-3 max-w-[600px]"
                        : "absolute z-100 left-[55%] top-[70%] flex flex-col gap-3 max-w-[600px]"
                    }
                  >
                    <button
                      onClick={scrollToSection}
                      className="cursor-pointer text-[26px] bg-purpledark text-white hover:bg-white hover:text-purple px-6 py-3 rounded-full font-semibold w-50 transition-colors duration-500"
                    >
                      Vamos lá
                    </button>
                  </div>
      ...
      <section
        id="products"
        className="flex flex-col items-center h-[120vh] mt-30"
      >
        ...
        <div className="w-full mt-15 relative">
          ...
          >
            {products?.map((item, index) => (
              <SwiperSlide
                key={index}
                className="group flex flex-col items-center cursor-pointer mb-10"
              >
                <div className="flex flex-col h-max-[100vh] w-[258px] gap-1">
                  <div
                    className="w-[258px] h-[278px] transition-transform duration-300 group-hover:scale-110 group-hover:z-10 relative"
                  ...
                  <h1 className="text-black opacity-70 text-[22px] h-[70px] font-secondary not-italic [font-optical-sizing:auto] font-bold w-full mt-3">
                    {item.titulo_}
                  </h1>
                  <p className="w-full text-[13px] text-black h-[40px]">
          ...
          <div className="custom-prev absolute left-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
            <img className="transform scale-x-[-1]" src={seta} alt="" />
          </div>
          <div className="custom-next absolute right-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
            <img src={seta} />
          </div>
        </div>
      </section>
      <section
        id="products#2"
        className="flex flex-col items-center h-[120vh] mt-20"
      >
        ...
        <div className="w-full mt-15 relative">
          ...
          <div className="custom-prev-2 absolute left-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
            <img className="transform scale-x-[-1]" src={seta} alt="" />
          </div>
          <div className="custom-next-2 absolute right-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
            <img src={seta} alt="" />
          </div>
        </div>
      </section>
      <section className="relative flex flex-row w-295 h-[45vh] ml-30 mr-30 mt-25 gap-5">
        <div className="flex flex-col w-80 gap-2 h-full">
          <h1 className="text-blackwhite text-[28px] font-medium leading-[35px] tracking-[1px] font-secondary">
            A realidade sobre nossas entregas
          </h1>
          <p className="text-blackwhite text-[15px] font-secondary">
            Felizmente, com todo o esforço da nossa trajetória, recebemos
            diversos feedbacks dos clientes — e achamos importante
            compartilhá-los.
          </p>
          <div className="mt-2">
            <img src={pessoas} alt="" />
        ...
        >
          {comments?.map((item, index) => (
            ...
            >
              ...
              <h1 className="w-70 text-[16px] font-secondary font-bold text-extradarkpurple">
                {item.product_title}
              </h1>
        ...
        <div className="custom-next-comments absolute right-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
          <img src={seta_comments} />{" "}
        </div>
      </section>
      ...
      >
        ...
        <div className="w-full mt-15 relative">
          ...
          <div className="custom-prev-3 absolute left-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
            <img className="transform scale-x-[-1]" src={seta} alt="" />
          </div>
          <div className="custom-next-3 absolute right-[-100px] top-[45%] w-15 -translate-y-1/2 z-10 cursor-pointer">
            <img src={seta} alt="" />
          </div>
        </div>
      ...
      <section className="relative w-full h-[100vh] flex items-start justify-center mt-70">
        <div className="h-full w-295 flex flex-col">
          <div className="w-full flex h-[70%]">
            <div className="w-[70%]">
              <h1 className="font-secondary text-extradarkpurple font-bold text-5xl p-4">
                Produtos Errados Podem Danificar Sua Pele
              </h1>
              <h2 className="p-4 font-primary text-salmon font-medium text-2xl">
                Personalize o seu com Segurança
              </h2>
              <p className="font-secondary text-[1.43rem] text-black opacity-70 ml-4 mt-9 w-[90%]">
                Na SKYNS, entendemos que cada pele é única, e que nem todo
                produto funciona da mesma forma para todos. Sabemos que algumas
                formulações industrializadas podem conter substâncias que
                irritam, sensibilizam ou até agravam condições como acne,
                dermatites ou rosácea.
              </p>
              <p className="font-secondary text-[1.43rem] text-black opacity-70 ml-4 mt-5 w-[95%]">
                Por isso, desenvolvemos uma funcionalidade exclusiva no nosso
                sistema: você pode personalizar a composição de determinados
                produtos, escolhendo ingredientes compatíveis com o seu tipo de
                pele e evitando substâncias que já causaram reações ou
                desconforto.
              </p>
            </div>
            <img src={woman} alt="" />
          </div>
          <p className="font-secondary text-[1.43rem] w-full text-black opacity-70 ml-4 mt-15">
            Essa personalização é feita com base em critérios dermatológicos e
            pensada para promover o equilíbrio da barreira cutânea, respeitando
            as necessidades específicas da sua pele. O resultado é um cuidado
            mais seguro, eficaz e consciente, feito sob medida para você. Sua
            pele fala. Nós ouvimos. E damos a você o poder de escolher.
          </p>
        </div>
      </section>
      <section className="flex flex-col h-[100vh] w-full justify-center items-center gap-3">
        <p className="font-primary text-[25px] text-salmon">
          Acne não define você
        </p>
        <h1 className="font-secondary text-5xl mt-5 text-extradarkpurple w-200 font-medium text-center">
          Cuidado de verdade começa com conhecimento da sua pele.
        </h1>
